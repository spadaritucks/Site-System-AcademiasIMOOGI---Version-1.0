...
<body>
    ...
    <main>
        <section class="primeiroAcessoArea">
            ...
            <form id="formNovaSenhaFuncionario">
                <div class="formComponent">
                    <span>Insira sua nova senha</span>
                    <input type="password" placeholder="Nova Senha" id="nova_senha">
                </div>
                <div class="formComponent">
                    <span>Repita a senha</span>
                    <input type="password" placeholder="Repita a senha" id="senha_repetida">
                </div>
                <div class="buttons">
