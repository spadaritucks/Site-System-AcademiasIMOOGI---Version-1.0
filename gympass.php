...
<body>
    ...
    <img class = "logoEmpresa" width="400px" src="imagens/gympass-logo.png" alt="">
    <div class = "descriçãoEmpresa">
        <h2>Como Funciona?</h2>
        ...
        <p>O Cliente Gympass deve possuir o <strong style="text-transform: uppercase;"> Plano Silver</strong> adiante e 
        ...
        <button class = "atendimento-gympass"><a href="https://api.whatsapp.com/send/?phone=5511988537726&text&type=phone_number&app_absent=0">Atendimento IMOOGI - Whatsapp</a></button>
    </div>
