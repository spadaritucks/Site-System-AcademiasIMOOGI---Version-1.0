            ...
            <div class="list-plan">
                ...
                <div class="table-responsive-sm">
                    <table class="table table-light">
                        <thead>
                            <tr>
                                <th scope="col-sm">Id do Plano</th>
                                <th scope="col-sm">Nome do Plano</th>
                                <th scope="col-sm">Duração do Plano</th>
                                <th scope="col-sm">Modalidades Permitidas</th>
                                <th scope="col-sm">Valor Integral do Plano</th>
            ...
            <div class="create-plan">
                ...
                <div class="areaAddPlano">
                    <form method="POST" id="addPlanoForm">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Link de Pagamento</label>
                            <input type="text" class="form-control" name="link_pagamento" id="link_pagamento" required />
                            <small id="helpId" class="form-text text-muted">Insira o valor inteiro</small>
                        </div>
                ...
                <div class="areaUpdatePlano">
                    <form method="POST" id="updatePlanoForm">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Link de Pagamento</label>
                            <input type="text" class="form-control" name="update_pagamento" id="update_pagamento" required />
                            <small id="helpId" class="form-text text-muted">Insira o link de pagamento</small>
                        </div>
